...
class ConfidencePredictorWrapper(PostHocUQ):
    """PostHocUQ model based on the "confidence" performance predictor
    (uq360.algorithms.blackbox_metamodel.predictors.core.confidence.py). """
